...
@NgModule({
  declarations: [AppComponent,EpisodioComponent,SafePipe,HipodromoComponent,EncuestasComponent, AccComponent, AddEpisodioComponent,LoginemailComponent,HipodromoadminComponent, GacetaComponent],
  entryComponents: [EpisodioComponent,HipodromoComponent,AccComponent, AddEpisodioComponent, EncuestasComponent,
